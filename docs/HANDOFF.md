...
**Production trading (Scheme C):**
- Live and paper Alpaca accounts running daily at 4:30 PM ET on Scheme C
  scoring (entry 9.0 / exit < 5.0 / persistence 3 / stop 20% / cap 12).
- Live launched 2026-04-28 with $5k. Paper has been running since
...
See `docs/README.md` for the directory map. Key entries:
